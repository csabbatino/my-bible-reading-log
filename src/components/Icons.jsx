// Clean monochrome line icons — consistent 24x24 viewBox
// strokeWidth 1.75 for a modern, refined feel

const icon = (paths) => ({ size = 22, color = "currentColor", style = {} } = {}) => (
  <svg
...
export const FamilyIcon = icon(<>
  ...
  <path d="M17 20v-1.5a4 4 0 0 0-2.5-3.7"/>
</>);
...
export const NotePublicIcon = icon(<>
...
export const BackIcon = icon(<><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/></>);
...
export const FireIcon = icon(<path d="M12 2c0 0-5 4-5 9a5 5 0 0 0 10 0c0-2-1-4-2-5 0 2-1 3-3 3s-2-2-2-3c0-2 2-4 2-4z"/>);
